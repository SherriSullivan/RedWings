...
function mousemoveHandler (e) {
  const mouseY = e.clientY - canvasHockey.offsetTop - 100;
...
function touchmoveHandler (e) {
  e.preventDefault();
  const touchY = e.touches[0].clientY - 175;
...
function drawRink () {
  ...
  rink.strokeRect(rinkW - 21, rinkH / 3, -10, rinkH / 3);
  rink.fillRect(23, rinkH / 3, 10, rinkH / 3);
