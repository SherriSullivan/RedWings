...
/**** Roster Script for 2020 Red Wings site ****/
...
async function getRoster() {
    ...
    for (var i = 0, l = data.roster.length; i < l; i++) {
        let ID, nmbr, fName, lName, name, position, type, age, ht, wt, shoots, city, statProv, country, stats;
        let rank = '';
        let rookie = '';
        ...
        playerStats = await statsResponse.json();
            ...
            let goalieStats, starts, wins, losses, savePerc, shutouts;
